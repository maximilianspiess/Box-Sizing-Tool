...
#define EXTENDER_SDA 2 // Pin on Heltec Board
#define EXTENDER_SCL 14 //Pin on Heltec Board
...
const int echoPinX = P1; //PIN 2 on Extender

const int trigPinY = P2; //PIN 3 on Extender
const int echoPinY = P3; //PIN 4 on Extender

const int trigPinZ = P4; //PIN 5 on Extender
const int echoPinZ = P5; //PIN 6 on Extender

// ---------------------------------- SCALE CONNECTION PINS
HX711 scale;

uint8_t dataPin = 15; //PIN D8 on Heltec Board
uint8_t clockPin = 13; //PIN D7 on Heltec Board
...
void setup()
{
  ...
  pcf8574.pinMode(echoPinX, INPUT);
  pcf8574.pinMode(echoPinY, INPUT);
  pcf8574.pinMode(echoPinZ, INPUT);
